<div align="center">
  <img src="./public/servicesmith-logo.svg" alt="ServiceSmith — 可视化锻造后端架构" width="720" />
</div>

<p align="center">
  <strong>通过可视化拓扑设计、模拟、学习并生成后端系统。</strong>
</p>
...
- `src/catalogLocale.ts`：本地化节点与分类内容
- `src/i18n.tsx`：全局语言状态与持久化
...
ServiceSmith 基于 [MIT License](LICENSE) 发布。
